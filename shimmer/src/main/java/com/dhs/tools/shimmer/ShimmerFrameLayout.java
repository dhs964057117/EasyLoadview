...
public class ShimmerFrameLayout extends FrameLayout {
  ...
  private void init(Context context, @Nullable AttributeSet attrs) {
    ...
    @SuppressLint("CustomViewStyleable") TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ShimmerView, 0, 0);
    try {
      Shimmer.Builder shimmerBuilder =
          a.hasValue(R.styleable.ShimmerView_shimmer_colored)
